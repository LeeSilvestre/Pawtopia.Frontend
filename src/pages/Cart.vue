<template>
    <div class="shopping-cart-section">
                                    ...
                                    <div class="box-content row">
                                        ...
                                        <div class="item-qty col-sm-2 d-inline">
                                            ...
                                            <input type="number" id="iQuantity" class="form-control item-quantity"
                                                :value="itemQuantity[index]" min="1" max="30"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +63 951-123-1234</h3>
                                <span class="small">
        ...
        <div v-if="isOrderExceedingLimit" class="custom-delete-modal">
            <div class="custom-modal-inner">
                <h2>Order cannot exceed ₱10,000.</h2>
                <div class="buttons">
                    <button class="btn btn-secondary" @click="isOrderExceedingLimit = false">OK</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async onQtyChange(e, i) {
            ...
            } else if (e.target.value > 30) {  // Add this condition
                e.target.value = 30;
                this.itemQuantity[i] = 30; 
            } else {
        ...
        checkOutBtn: function () {
            const totalAmount = this.calculateSummaryPrice()[3];

            if (totalAmount > 10000) {
                // Display pop-up message
                this.isOrderExceedingLimit = true;
            } else {
