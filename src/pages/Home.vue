<template>
    <div>
        <div class="home-main">
            <div class="content">
                <h1 style="color: #27ae60; font-size: 50px">Welcome to Pawtopia</h1>
                <h3 style="font-size: 30px">Unleash Joy, Delivered!</h3>
                <p>Serving the best quality pet supplies for you.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/d.png" alt="" class="home-img">
