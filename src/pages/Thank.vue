<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Thank you for using CulinaryNex!</p>
            <p v-none>
                We have just received your order. Please proceed to the counter
                for confirmation and payment of order.
            </p>
            <router-link class="btn" to="/menu">Order More</router-link>
        </div>
    </div>
</template>
