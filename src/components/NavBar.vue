<template>
    <div class="header">
        ...
        <img src="../assets/images/d.png" alt="taco-logo" />
        Pawtopia
    </router-link>
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/menu">shop</router-link>
            <router-link @click="scrollToTop()" to="/table">terms & condition</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    ...
                    <li>
                        <router-link @click="goToHistory" to="/myorderhistory">history</router-link>
                    </li>
                    <li>
                        <router-link @click="goToCancel" to="/cancelledorder">cancelled</router-link>
                    </li>
                    <li>
...
export default {
    ...
    methods: {
        ...
        goToHistory() {
            this.$router.push("/myorderhistory");
        },
        goToCancel() {
            this.$router.push("/cancelledorder");
        },
    }
}
</script>
