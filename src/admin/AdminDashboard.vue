<template>
    <div class="admin-container">
        <div class="d-flex justify-content-between">
            ...
            <!--<router-link @click="scrollToTop()" to="/admin/managemenu">Manage Menu</router-link>-->
            <button class="btn manage-menu-btn" @click="goToManageMenu" to="/admin/managemenu">Manage Menu</button>
            ...
            <table class="table colored-header datatable project-list">
                ...
                <tbody>
                    <tr v-for="(b) in filterBills.slice().reverse()" :key="b.bill_id">
                        ...
                        <td>
                            <button v-if="b.bill_status === 1 && b.bill_paid === 'false'" class="paid-btn" @click="paidBtn(b.bill_id)">
                                Paid
                            </button>

                            <button v-if="b.bill_status === 1 && b.bill_paid === 'true'" class="action-btn" @click="nextStatusBtn(b.bill_id)">
                            ...
                            <button v-if="b.bill_status < 1" class="action-btn" @click="nextStatusBtn(b.bill_id)">
                                {{ avaiableStatus[b.bill_status + 1] }}
                            </button>
                        </td>
                    </tr>
...
export default {
    ...
    data() {
        return {
            avaiableStatus: ["cancel", "pending", "confirmed", "packing", "now delivering", "delivered"],
            allBills: [],
