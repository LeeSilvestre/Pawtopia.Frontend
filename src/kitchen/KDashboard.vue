<template>
    <div class="admin-container">
      <div class="d-flex justify-content-between">
        ...
        <button class="btn" @click="handleLogout()" to=/kitchen>Logout</button>
      </div>
      <div class="heading">
            ...
            <table class="table colored-header datatable project-list">
                ...
                <tbody>
                    <tr v-for="(order) in filterBills.slice().reverse()" :key="order.bill_id">
                        ...
                        <td>
                    <button v-if="canUpdateStatus(order) && order.bill_status === 2" class="action-btn" @click="nextStatusBtn(order.bill_id)">
                    Pack
                    </button>
                    <button v-if="canUpdateStatus(order) && order.bill_status === 3" class="action-btn" @click="nextStatusBtn(order.bill_id)">
                    Deliver
                    </button>
                    <button v-if="canUpdateStatus(order) && order.bill_status === 4" class="action-btn" @click="nextStatusBtn(order.bill_id)">
                    Delivered
                    </button>
                    <button v-if="canUpdateStatus(order) && order.bill_status === 4 && order.bill_paid === 'false'" class="paid-btn" @click="paidBtn(order.bill_id)">
                    Paid
                    </button>
                </td>
                    </tr>
